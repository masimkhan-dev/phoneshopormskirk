...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Phone Shop Ormskirk | Phone Repairs & Accessories" },
      {
        name: "description",
        content:
  ...
  loader: async ({ context }) => {
    // Prime the shared business settings so address, phone and hours are in the SSR HTML.
    await context.queryClient.ensureQueryData(businessQuery());
  },
...
function RootComponent() {
  ...
  // Internal system (admin + auth) renders without the public site chrome.
