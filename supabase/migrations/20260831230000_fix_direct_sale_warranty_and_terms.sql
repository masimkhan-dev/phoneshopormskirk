-- Ensure invoice_terms_settings allows warranty customization for SALES/Direct Sale
UPDATE public.invoice_terms_settings
SET enable_warranty = true
WHERE type = 'SALES';

-- Allow explicit warranty and customer message override in apply_invoice_terms matching exact schema
